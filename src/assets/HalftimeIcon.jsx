...
function HalftimeIcon({ stepId }) {
  return (
    <svg id="halftime-icon" width={150} height={100}>
      <g id="rect-1" fill="#164971" opacity={stepId >= 10 ? 1 : 0}>
        <polygon
          className="st0"
      ...
      <g id="rect-2" fill="#ff7676" opacity={stepId >= 11 ? 1 : 0}>
        <polygon
          className="st1"
      ...
      <g id="rect-3" fill="#ffdf7e" opacity={stepId >= 12 ? 1 : 0}>
        <polygon
          className="st2"
